...
```{r}
setwd("C:/Users/johnl/Desktop/Courses/Data Analysis/Coursera/Reproducible Research/Week 2")
...
plot(steps ~ interval| factor(Day), data = weekdayweekend, type = "l", main="m", xlab="x", ylab="y")

plot(steps~ interval, data = weekdayweekend, col = weekdayweekend$Day, type="l", bg = "blue")
lines(weekdayweekend, weekdayweekend$Weekday, type="l", col = "red")
lines(weekdayweekend, weekdayweekend$Weekend, type="l", col = "red")
